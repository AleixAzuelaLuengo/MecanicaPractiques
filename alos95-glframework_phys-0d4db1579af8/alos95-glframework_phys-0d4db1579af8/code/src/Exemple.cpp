...
namespace Utils
{
	...
	Utils::Plane cubePlaneCollision[6];
...
void Exemple_PhysicsInit()
{
	...
	cubePlaneCollision[3] = Utils::Plane(pointsPlane4[0], pointsPlane4[1], pointsPlane4[2]);
	cubePlaneCollision[4] = Utils::Plane(pointsPlane5[0], pointsPlane5[1], pointsPlane5[2]);
	cubePlaneCollision[5] = Utils::Plane(pointsPlane6[0], pointsPlane6[1], pointsPlane6[2]);
